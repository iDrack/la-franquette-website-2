...
<div class="container mx-auto">
    <div class="flex flex-col justify-center lg:flex-row items-center gap-16 mt-6 mx-auto max-w-4xl">
                <div class="">
                    ...
                    <div class="mt-12 flex flex-col content-center items-center">
                        <ul class="mt-3">
                            <li class="flex flex-col lg:flex-row items-center">
                                ...
                                <div class="text-center lg:text-start text-sm lato-light ml-3">
